...
?>
<!-- Global Confirmation Modal (WCAG 2.2 / WAI-ARIA Modal Dialog Pattern) -->
<div class="modal-overlay" id="global-confirm-modal" style="display:none; z-index: 9999;" role="dialog" aria-modal="true" aria-labelledby="global-confirm-title-text" aria-describedby="global-confirm-message">
    <div class="modal" style="max-width:440px;">
        <div class="modal-header">
            <h3 id="global-confirm-title" style="display:flex; align-items:center; gap:0.5rem; margin:0;">
                <i id="global-confirm-icon" class="fas fa-triangle-exclamation" style="color:var(--warning); font-size:1.1rem;" aria-hidden="true"></i>
                <span id="global-confirm-title-text">Confirm Action</span>
            </h3>
        ...
        <div style="display:flex; gap:0.75rem; justify-content:flex-end;">
            <button type="button" class="btn btn-outline" onclick="closeGlobalConfirm()" style="min-height:44px; min-width:88px;">Cancel</button>
            <button type="button" class="btn btn-primary" id="global-confirm-btn" style="min-height:44px; min-width:88px;">Confirm</button>
        </div>
    </div>
</div>
