...
$email_subject = "Membership Successfully Renewed! [{$time_str}] — Palma's Elite Gym";
...
$email_body = "
    ...
    <div style=\"background-color:#F4F9F6; border:1px solid #D8E6DC; border-radius:10px; padding:18px; margin:20px 0;\">
        ...
        <table style=\"width:100%; font-size:13px; color:#334155; border-collapse:collapse;\">
            <tr><td style=\"padding:4px 0;\"><strong>Membership ID:</strong></td><td style=\"text-align:right; font-family:monospace; font-weight:bold; color:#1B4332;\">GYM-26515</td></tr>
            ...
            <tr><td style=\"padding:4px 0;\"><strong>Reference No:</strong></td><td style=\"text-align:right; font-family:monospace;\">PEG-LIVE-" . strtoupper(substr(uniqid(), -6)) . "</td></tr>
            <tr style=\"border-top:1px dashed #CBD5E1;\"><td style=\"padding:8px 0 0;\"><strong>New Expiry Date:</strong></td><td style=\"padding:8px 0 0; text-align:right; font-weight:bold; color:#1B4332;\">" . date('F j, Y', strtotime('+1 month')) . "</td></tr>
        </table>
    </div>
